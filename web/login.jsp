                                ...
                                <TD>
                                    ...
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        ...
                                        <TR>
                                            ...
                                            <TD>
                                                <%--<input type=button style="background: url('images/regist_button.gif' ); width: 104px" onclick="registUI()"/>--%>
                                                <%--<input type=image src="images/regist_button.gif" onclick="registUI()"/>--%>
                                                <img src="images/regist_button.gif" onclick="registUI()">
                                            </TD>
                                        </TR>
                                        </TBODY>
                                    </TABLE>
